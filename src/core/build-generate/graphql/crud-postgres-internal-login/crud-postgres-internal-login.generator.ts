...
/**
 * Run Option Generator PostgreSQL internal LOGIN (CRUD).
 *
 * @author David rivero (ErCompa) <davidmriverog@gmail.com>
 */
export async function runOptionPostgreSQLInternalLogin() {
  try {
    ...
    await GenerateCrudEntityGrapHQLPostgres(entityName, crudModelPath)
