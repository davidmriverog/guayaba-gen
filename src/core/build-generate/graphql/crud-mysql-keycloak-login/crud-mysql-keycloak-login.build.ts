...
import { GenerateCrudEntityGrapHQLMySQL } from "../crud-mysql-internal-login/generator/crud-mysql-entity-graphql.generator"
import { GenerateCrudResolverKeycloakLoginModule } from "./generator/crud-mysql-keycloak-resolver.generator"

/**
 * Run Option Generator MySQL Keycloak LOGIN (CRUD).
 *
...
export async function runOptionMySQLKeycloakLogin() {
  ...
  try {
    ...
    await GenerateCrudResolverKeycloakLoginModule(entityName, crudModelPath)
