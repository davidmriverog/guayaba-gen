...
import { GenerateCrudEntityGrapHQLMongoDB } from "./generator/crud-mongo-entity-graphql.generator"
import { GenerateCrudServiceMongoDBModule } from "./generator/crud-mongo-service-graphql.generator"
import { GenerateCrudModuleEntityMongoGrapHQLModule } from "./generator/crud-mongo-module-entity-graphql.generator"
import { GenerateCrudResolverInternalLoginMongoModule } from "./generator/crud-mongo-resolver-graphql.generator"

/**
 * Run Option Generator MongoDB internal LOGIN (CRUD).
 *
 * @author David rivero (ErCompa) <davidmriverog@gmail.com>
 */
export async function runOptionMongoDBInternalLogin() {
  try {
    ...
    await GenerateCrudEntityGrapHQLMongoDB(entityName, crudModelPath)
    ...
    await GenerateCrudServiceMongoDBModule(entityName, crudModelPath)
    ...
    await GenerateCrudResolverInternalLoginMongoModule(entityName, crudModelPath)
    ...
    await GenerateCrudModuleEntityMongoGrapHQLModule(entityName, crudModelPath)
