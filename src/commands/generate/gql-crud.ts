...
import { GenerateCrudEntityModule, GenerateCrudModuleEntityModule, GenerateCrudResolverModule, getDefaultConfig, UpdateRootHQLModule, UpdateRootModule } from "../../core";
import { singular } from "pluralize";
import { GenerateCrudDtoModule } from "../../core/generate/gql-nsql/crud-dto.generate";
import { GenerateCrudServiceModule } from "../../core/generate/gql-nsql/crud-service.generate";

export class RestCrudModule extends Command {
  ...
  async run() {
    ...
    const { args, flags } = this.parse(RestCrudModule);
    ...
    await GenerateCrudDtoModule(prefix, name, crudModelPath);
    ...
    await GenerateCrudModuleEntityModule(name, crudModelPath);
